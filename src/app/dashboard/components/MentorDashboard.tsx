...
import { FiSearch, FiHome, FiCompass, FiUsers, FiCalendar, FiMessageCircle, FiAward, FiArrowLeft, FiArrowRight, FiCheck, FiCopy, FiExternalLink, FiHeart, FiShare2, FiBookmark } from 'react-icons/fi';
